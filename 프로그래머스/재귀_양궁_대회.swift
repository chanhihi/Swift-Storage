...
var highScore = 1
var highScoreArray: Set<[Int]> = []
let SCORES = 10
var minArrows = Array(repeating: 0, count: 11)
...
print(solution(9, [3,2,1,1,1,1,0,0,0,0,0]))
